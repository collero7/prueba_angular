...
app.controller('detalleCtrl', ['$scope', '$routeParams', '$http', 'Funciones', function($scope, $routeParams, $http, Funciones){
	...
	$http.get(Funciones.URL + 't=' + encodeURI($scope.detalle) + Funciones.KEY)
	...
	$scope.gestionFavorito = () => {

		//Hacemos llamada al servicio para gestionar el favorito
		Funciones.gestionFavorito($scope.usuario, $scope.detalle).then(function(datos){ //Tratamos la promesa
